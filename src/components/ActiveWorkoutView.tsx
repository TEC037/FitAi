...
export const ActiveWorkoutView: React.FC = () => {
  ...
  const [currentWeight, setCurrentWeight] = useState<number>(currentExercise.suggestedWeightKg || 80);
  ...
  }, [allometricProfile, isRestTimerActive, currentRpe, restTimerSeconds, currentExercise.primaryMuscle, lastPeakBpm]);
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-white/50">
                Fisiología calculada para {user.weight} kg • RHR basal: {allometricProfile.allometricRestingHr} bpm
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center mb-8">
          <div className="md:col-span-8">
            ...
            <p className="text-xs sm:text-sm text-white/70 bg-white/5 border border-white/5 p-3.5 rounded-2xl leading-relaxed">
              💡 <strong className="text-white">Indicación técnica:</strong> {currentExercise.technicalCue}
            </p>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-black text-white">
                Serie {activeSetIndex} <span className="text-sm text-white/40">de {currentExercise.sets}</span>
              </h3>
            </div>
            ...
            <div className="bg-[#050505] p-4 rounded-2xl border border-white/10">
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex gap-1.5">
                  ...
                  <button
                    onClick={() => setCurrentWeight((w) => Math.max(0, Number((w - 2.5).toFixed(1))))}
                    className="w-9 h-9 rounded-xl bg-white/5 hover:bg-white/15 text-white/70 text-xs font-bold transition-colors"
                  >
                    -2.5
                  </button>
              ...
              <div className="mt-3 pt-2.5 border-t border-white/5 flex items-center justify-between text-[11px]">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-white/40">
                    Eq. 70kg: <strong className="text-[#C0FF00] font-mono">{currentStrengthScore.normalized70kgLoad} kg</strong>
                  </span>
          ...
          <div>
            <div className="flex justify-between items-center text-xs mb-2">
              <span className="font-semibold text-white/70">
                Esfuerzo Percibido (RPE 1-10): <strong className="text-[#C0FF00] font-black">{currentRpe}</strong>
              </span>
        ...
        {currentSetsOfExercise.length > 0 && (
          <div className="mt-8 pt-6 border-t border-white/10">
            ...
            <div className="space-y-2">
              {currentSetsOfExercise.map((set, idx) => (
                <div
                  key={idx}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/50">
                      Has registrado {activeWorkoutSets.length} series en {formatTime(workoutElapsedTime)}.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6 text-center animate-fadeIn">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  <div className="bg-white/5 p-3 rounded-2xl border border-white/5">
                    ...
                    <p className="text-lg font-black text-white">{summaryData.durationMinutes} min</p>
                  </div>
                  <div className="bg-white/5 p-3 rounded-2xl border border-white/5">
                  ...
                  <div className="bg-white/5 p-3 rounded-2xl border border-white/5">
                    <p className="text-[10px] text-white/40 uppercase font-bold">Calorías (Kleiber x^3/4)</p>
                  ...
                  <div className="bg-white/5 p-3 rounded-2xl border border-white/5">
                    ...
                    <p className="text-lg font-black text-red-400">
                      {summaryData.averageHeartRate || 142} <span className="text-xs text-white/40">BPM</span>
                    </p>
                    <p className="text-[10px] text-white/40">Pico: {summaryData.peakHeartRate || 165} BPM</p>
                  </div>
                  <div className="bg-white/5 p-3 rounded-2xl border border-white/5">
          ...
          <div className="bg-[#0D0D0D] border border-white/15 rounded-[28px] max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-2">
              ...
              <p className="text-xs text-white/70 leading-relaxed">
                En biología de sistemas, la frecuencia cardíaca de reposo disminuye con la masa corporal siguiendo la ley de cuarto de potencia: <strong className="text-white font-mono">f_HR ∝ M^(-1/4)</strong>. Paralelamente, la duración del ciclo cardíaco y la constante de recuperación post-esfuerzo escalan con <strong className="text-white font-mono">τ ∝ M^(1/4)</strong>.
              </p>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-2">
              ...
              <p className="text-xs text-white/70 leading-relaxed">
                El gasto metabólico basal y activo no escala linealmente (M^1) ni con la superficie (M^2/3), sino con <strong className="text-white font-mono">BMR ∝ M^(3/4)</strong>, debido a las restricciones hidrodinámicas de las redes capilares fractales. Esto permite una estimación calórica mucho más precisa durante las series.
              </p>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-2">
              ...
              <p className="text-xs text-white/70 leading-relaxed">
                La fuerza muscular máxima está determinada por el área de sección transversal del músculo (L^2), mientras que la masa corporal depende del volumen (L^3). Por tanto, la fuerza relativa biológicamente justa se normaliza mediante el índice <strong className="text-white font-mono">S = Carga / (M^(2/3))</strong>.
              </p>
