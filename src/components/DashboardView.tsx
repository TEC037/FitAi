...
import { getExerciseImageUrl } from '../services/exerciseDatabaseService';

export const DashboardView: React.FC = () => {
  const { user, routines, startWorkout, navigateTo, history } = useApp();
    ...
    <div className="flex-1 p-4 sm:p-8 flex flex-col gap-8 relative overflow-hidden max-w-[1600px] mx-auto w-full">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-4 relative z-10">
        <div>
          ...
          <p className="text-white/60 text-sm sm:text-base">
            Hoy toca machacar el <span className="text-white font-medium">{todaysRoutine.focus}</span>. ¿Listo para el progreso?
          </p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
              <div>
                ...
                <p className="text-white/60 text-sm max-w-md leading-relaxed">
                  {todaysRoutine.exercises.length} ejercicios • {todaysRoutine.estimatedMinutes} min • Alta Intensidad
                  <br />
                  <span className="text-white/40">Enfoque: Hipertrofia y control de fase excéntrica.</span>
                </p>
              ...
              <div className="w-24 h-24 border-4 border-[#C0FF00]/20 rounded-full flex items-center justify-center relative shrink-0 self-center sm:self-start">
                ...
                <div className="text-center">
                  ...
                  <span className="text-[9px] text-[#C0FF00] font-bold tracking-wider uppercase">Calibrado</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex-1 bg-white/5 border border-white/10 rounded-[32px] p-6 flex flex-col justify-between group hover:border-[#C0FF00]/30 transition-all">
            <div>
              ...
              <p className="text-sm text-white/70 italic leading-relaxed">
                "He ajustado el peso sugerido para tu Press de Banca un +2.5kg basándome en tu última sesión. Tus sensaciones de ayer indican que estás listo para sobrecarga progresiva."
              </p>
            </div>
          ...
          <div className="flex-1 bg-indigo-600/10 border border-indigo-500/20 rounded-[32px] p-6 relative group overflow-hidden flex flex-col justify-between">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] text-white/40 font-mono">+5.2% vs prev</span>
              </div>
              <h3 className="text-3xl sm:text-4xl font-black tracking-tighter text-white">
                12.450 <span className="text-sm font-normal text-white/40">kg</span>
              </h3>
            </div>
            ...
            <div className="mt-4">
              <div className="flex items-end gap-1.5 h-14">
                <div className="flex-1 flex flex-col items-center gap-1">
                  <div className="w-full bg-indigo-500/20 h-5 rounded-sm" />
                  <span className="text-[9px] text-white/30">S1</span>
                </div>
                <div className="flex-1 flex flex-col items-center gap-1">
                  <div className="w-full bg-indigo-500/30 h-8 rounded-sm" />
                  <span className="text-[9px] text-white/30">S2</span>
                </div>
                <div className="flex-1 flex flex-col items-center gap-1">
                  <div className="w-full bg-indigo-500/50 h-10 rounded-sm" />
                  <span className="text-[9px] text-white/30">S3</span>
                </div>
                <div className="flex-1 flex flex-col items-center gap-1">
                  <div className="w-full bg-[#C0FF00] h-14 rounded-sm shadow-[0_0_10px_rgba(192,255,0,0.5)]" />
                  <span className="text-[9px] text-[#C0FF00] font-bold">Hoy</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 relative z-10">
        <div className="bg-white/5 p-5 rounded-[24px] border border-white/10 flex items-center gap-4 hover:border-white/20 transition-colors">
          ...
          <div>
            <p className="text-[10px] text-white/40 uppercase tracking-wider font-semibold">Peso Actual</p>
            <p className="font-black text-lg text-white">{user.weight} kg</p>
            <p className="text-[10px] text-emerald-400 font-medium">-1.3 kg este mes</p>
          </div>
        </div>
        ...
        <div className="bg-white/5 p-5 rounded-[24px] border border-white/10 flex items-center gap-4 hover:border-white/20 transition-colors">
          ...
          <div>
            <p className="text-[10px] text-white/40 uppercase tracking-wider font-semibold">Workouts</p>
            <p className="font-black text-lg text-white">12 / Mes</p>
            <p className="text-[10px] text-[#C0FF00] font-medium">4 esta semana</p>
          </div>
        </div>
        ...
        <div className="bg-white/5 p-5 rounded-[24px] border border-white/10 flex items-center gap-4 hover:border-white/20 transition-colors">
          ...
          <div>
            <p className="text-[10px] text-white/40 uppercase tracking-wider font-semibold">Tiempo Total</p>
            <p className="font-black text-lg text-white">14.5 hrs</p>
            <p className="text-[10px] text-white/40 font-medium">Promedio 60 min/sesión</p>
          </div>
        </div>
        ...
        <div className="bg-[#C0FF00]/5 p-5 rounded-[24px] border border-[#C0FF00]/20 flex items-center gap-4 hover:border-[#C0FF00]/40 transition-colors">
          ...
          <div>
            <p className="text-[10px] text-[#C0FF00] uppercase font-bold tracking-wider">PR Record</p>
            <p className="font-black text-lg text-white">Bench 95 kg</p>
            <p className="text-[10px] text-[#C0FF00] font-medium">+2.7% nuevo récord</p>
          </div>
        </div>
      </div>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 text-xs text-white/60 mt-0.5">
                      ...
                      <span>•</span>
                      <span className="text-[#C0FF00] font-semibold">{ex.suggestedWeightKg} kg</span>
                    </div>
                  </div>
                </div>
